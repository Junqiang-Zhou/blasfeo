...
//	for(ii=0; ii<n; ii++) x_n[ii] = 1.0;
	...
	//
	int size_strmat = 5*d_memsize_strmat(n, n);
	void *memory_strmat; v_zeros_align(&memory_strmat, size_strmat);
	char *ptr_memory_strmat = (char *) memory_strmat;

	struct d_strmat *sA = d_create_strmat(n, n, ptr_memory_strmat);
	ptr_memory_strmat += sA->memsize;
	d_cvt_mat2strmat(n, n, A, n, sA, 0, 0);
	d_print_strmat(n, n, sA, 0, 0);

	struct d_strmat *sB = d_create_strmat(n, n, ptr_memory_strmat);
	ptr_memory_strmat += sB->memsize;
	d_cvt_mat2strmat(n, n, B, n, sB, 0, 0);
	d_print_strmat(n, n, sB, 0, 0);

	struct d_strmat *sC = d_create_strmat(n, n, ptr_memory_strmat);
	ptr_memory_strmat += sC->memsize;

	struct d_strmat *sD = d_create_strmat(n, n, ptr_memory_strmat);
	ptr_memory_strmat += sD->memsize;
	d_cvt_mat2strmat(n, n, D, n, sD, 0, 0);

	struct d_strmat *sE = d_create_strmat(n, n, ptr_memory_strmat);
	ptr_memory_strmat += sE->memsize;

	struct d_strvec *sx_n = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, x_n, sx_n, 0);

	struct d_strvec *sx_t = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, x_t, sx_t, 0);

	struct d_strvec *sy_n = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, y_n, sy_n, 0);

	struct d_strvec *sy_t = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, y_t, sy_t, 0);

	struct d_strvec *sz_n = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, z_n, sz_n, 0);

	struct d_strvec *sz_t = d_allocate_strvec(n);
	d_cvt_vec2strvec(n, z_t, sz_t, 0);

	struct d_strvec *sx0 = d_create_strvec(n, x0);
	struct d_strvec *sx1 = d_create_strvec(n, x1);
	struct d_strvec *sx2 = d_create_strvec(n, x2);
	struct d_strvec *sx3 = d_create_strvec(n, x3);
	struct d_strvec *sx4 = d_create_strvec(n, x4);
	struct d_strvec *sx5 = d_create_strvec(n, x5);
	struct d_strvec *sx6 = d_create_strvec(n, x6);
	struct d_strvec *sx7 = d_create_strvec(n, x7);
	struct d_strvec *sx8 = d_create_strvec(n, x8);
	struct d_strvec *sx9 = d_create_strvec(n, x9);

	struct d_strvec *sz0 = d_allocate_strvec(n);
	struct d_strvec *sz1 = d_allocate_strvec(n);
	struct d_strvec *sz2 = d_allocate_strvec(n);
	struct d_strvec *sz3 = d_allocate_strvec(n);
	struct d_strvec *sz4 = d_allocate_strvec(n);
	struct d_strvec *sz5 = d_allocate_strvec(n);
	struct d_strvec *sz6 = d_allocate_strvec(n);
	struct d_strvec *sz7 = d_allocate_strvec(n);
	struct d_strvec *sz8 = d_allocate_strvec(n);
	struct d_strvec *sz9 = d_allocate_strvec(n);
	...
	struct d_strvec *sv = d_create_strvec(n, v);
	struct d_strvec *svp = d_create_strvec(n, vp);
	struct d_strvec *svm = d_create_strvec(n, vm);
	struct d_strvec *sm = d_create_strvec(n, m);
	struct d_strvec *sr = d_create_strvec(n, r);
